...
def cosine_similarity(u, v):
	...
	# Compute the cosine similarity defined by formula for calculating cosine similarity
...
def equalize(pair, bias_axis, word_to_vec_map):
	...
	# Step 5: Adjust the Bias part of e_w1B and e_w2B using the formulas
...
if __name__ == '__main__':
	...
	check_cosine_similarity(words, word_to_vec_map)
	print()

	check_complete_analogy(words, word_to_vec_map)
	print()

	printing_baised_words(words, word_to_vec_map)
	print()

	check_neutralize(words, word_to_vec_map)
	print()

	check_equalize(words, word_to_vec_map)
	print()
